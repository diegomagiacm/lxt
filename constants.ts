...
export const PRODUCTS: Product[] = [
  ...
  // IPHONES NUEVOS
  // ==========================================
  { id: 'ip14-128', name: 'iPhone 14 128GB', price: 590, category: 'iPhone', description: 'Apple iPhone 14. Incluye: Funda, Glass, Cargador y Auriculares de regalo!', stock: true, image: getImg('iphone_14_128gb.png') },
  { id: 'ip15-128', name: 'iPhone 15 128GB', price: 670, category: 'iPhone', description: 'Dynamic Island. Incluye: Funda, Glass, Cargador y Auriculares de regalo!', stock: true, image: getImg('iphone_15_128gb.png') },
  { id: 'ip15-256', name: 'iPhone 15 256GB', price: 800, category: 'iPhone', description: 'Dynamic Island. Incluye: Funda, Glass, Cargador y Auriculares de regalo!', stock: true, image: getImg('iphone_15_128gb.png') },
  { id: 'ip15p-128', name: 'iPhone 15 Plus 128GB', price: 780, category: 'iPhone', description: 'Pantalla Grande. Incluye: Funda, Glass, Cargador y Auriculares de regalo!', stock: true, image: getImg('iphone_15_plus_512gb.png') },
  { id: 'ip15p-512', name: 'iPhone 15 Plus 512GB', price: 880, category: 'iPhone', description: 'Máxima capacidad. Incluye: Funda, Glass, Cargador y Auriculares de regalo!', stock: true, image: getImg('iphone_15_plus_512gb.png') },

  // iPhone 16
  { id: 'ip16e-128', name: 'iPhone 16E 128GB', price: 640, category: 'iPhone', description: 'Nueva Edición. Incluye: Funda, Glass, Cargador y Auriculares de regalo!', stock: true, image: getImg('iphone_16e_128gb.png') },
  { id: 'ip16e-256', name: 'iPhone 16E 256GB', price: 750, category: 'iPhone', description: 'Nueva Edición. Incluye: Funda, Glass, Cargador y Auriculares de regalo!', stock: true, image: getImg('iphone_16e_256gb.png') },
  { id: 'ip16-128', name: 'iPhone 16 128GB', price: 790, category: 'iPhone', description: 'A18 Chip. Incluye: Funda, Glass, Cargador y Auriculares de regalo!', stock: true, image: getImg('iphone_16_128gb.png') },
  { id: 'ip16-256', name: 'iPhone 16 256GB', price: 880, category: 'iPhone', description: 'A18 Chip. Incluye: Funda, Glass, Cargador y Auriculares de regalo!', stock: true, image: getImg('iphone_16_256gb.png') },
  { id: 'ip16pl-128', name: 'iPhone 16 Plus 128GB', price: 880, category: 'iPhone', description: 'Gran Pantalla. Incluye: Funda, Glass, Cargador y Auriculares de regalo!', stock: true, image: getImg('iphone_16_plus_128gb.png') },
  { id: 'ip16pl-256', name: 'iPhone 16 Plus 256GB', price: 1000, category: 'iPhone', description: 'Gran Pantalla. Incluye: Funda, Glass, Cargador y Auriculares de regalo!', stock: true, image: getImg('iphone_16_plus_256gb.png') },
  { id: 'ip16pro-128', name: 'iPhone 16 Pro 128GB', price: 1080, category: 'iPhone', description: 'Titanium. Incluye: Funda, Glass, Cargador y Auriculares de regalo!', stock: true, image: getImg('iphone_16_pro_128gb.png') },
  { id: 'ip16promax-256', name: 'iPhone 16 Pro Max 256GB', price: 1330, category: 'iPhone', description: 'Solo Desert Titanium. Incluye: Funda, Glass, Cargador y Auriculares de regalo!', stock: true, image: getImg('iphone_16_pro_max_256gb_desert.png') },

  // iPhone 17
  { id: 'ip17-256', name: 'iPhone 17 256GB', price: 990, category: 'iPhone', description: 'White, Blue, Lavender, Sage. Incluye: Funda, Glass, Cargador y Auriculares de regalo!', stock: true, colors: ['White', 'Blue', 'Lavender', 'Sage'], image: getImg('iphone_17_256gb_blue.png') },
  { id: 'ip17air-256', name: 'iPhone 17 Air 256GB', price: 980, category: 'iPhone', description: 'Ultra Thin. Incluye: Funda, Glass, Cargador y Auriculares de regalo!', stock: true, colors: ['Black', 'White', 'Blue', 'Gold'], image: getImg('iphone_17_air_256gb_black.png') },
  { id: 'ip17pro-256-og', name: 'iPhone 17 Pro 256GB (Orange)', price: 1330, category: 'iPhone', description: 'Titanium Orange. Incluye: Funda, Glass, Cargador y Auriculares de regalo!', stock: true, image: getImg('iphone_17_pro_256gb_orange.png') },
  { id: 'ip17pro-256-bl', name: 'iPhone 17 Pro 256GB (Blue)', price: 1340, category: 'iPhone', description: 'Titanium Blue. Incluye: Funda, Glass, Cargador y Auriculares de regalo!', stock: true, image: getImg('iphone_17_pro_256gb_blue.png') },
  { id: 'ip17pro-256-sl', name: 'iPhone 17 Pro 256GB (Silver)', price: 1350, category: 'iPhone', description: 'Titanium Silver. Incluye: Funda, Glass, Cargador y Auriculares de regalo!', stock: true, image: getImg('iphone_17_pro_256gb_silver.png') },
  { id: 'ip17pro-512-og', name: 'iPhone 17 Pro 512GB (Orange)', price: 1530, category: 'iPhone', description: 'Titanium Orange. Incluye: Funda, Glass, Cargador y Auriculares de regalo!', stock: true, image: getImg('iphone_17_pro_512gb_orange.png') },
  { id: 'ip17pro-512-bl', name: 'iPhone 17 Pro 512GB (Blue)', price: 1540, category: 'iPhone', description: 'Titanium Blue. Incluye: Funda, Glass, Cargador y Auriculares de regalo!', stock: true, image: getImg('iphone_17_pro_512gb_blue.png') },
  { id: 'ip17pro-512-sl', name: 'iPhone 17 Pro 512GB (Silver)', price: 1540, category: 'iPhone 17', description: 'Titanium Silver. Incluye: Funda, Glass, Cargador y Auriculares de regalo!', stock: true, image: getImg('iphone_17_pro_512gb_silver.png') },
  { id: 'ip17pro-1tb', name: 'iPhone 17 Pro 1TB', price: 1760, category: 'iPhone', description: 'Orange, Blue, Silver. Incluye: Funda, Glass, Cargador y Auriculares de regalo!', stock: true, colors: ['Orange', 'Blue', 'Silver'], image: getImg('iphone_17_pro_1tb_silver.png') },
  { id: 'ip17pm-256-og', name: 'iPhone 17 Pro Max 256GB (Orange)', price: 1420, category: 'iPhone', description: 'Max Orange. Incluye: Funda, Glass, Cargador y Auriculares de regalo!', stock: true, image: getImg('iphone_17_pro_max_256gb_orange.png') },
  { id: 'ip17pm-256-bl', name: 'iPhone 17 Pro Max 256GB (Blue)', price: 1430, category: 'iPhone', description: 'Max Blue. Incluye: Funda, Glass, Cargador y Auriculares de regalo!', stock: true, image: getImg('iphone_17_pro_max_256gb_blue.png') },
  { id: 'ip17pm-256-sl', name: 'iPhone 17 Pro Max 256GB (Silver)', price: 1430, category: 'iPhone', description: 'Max Silver. Incluye: Funda, Glass, Cargador y Auriculares de regalo!', stock: true, image: getImg('iphone_17_pro_max_256gb_silver.png') },
  { id: 'ip17pm-512-og', name: 'iPhone 17 Pro Max 512GB (Orange)', price: 1640, category: 'iPhone', description: 'Max Orange. Incluye: Funda, Glass, Cargador y Auriculares de regalo!', stock: true, image: getImg('iphone_17_pro_max_512gb_orange.png') },
  { id: 'ip17pm-512-bl', name: 'iPhone 17 Pro Max 512GB (Blue)', price: 1670, category: 'iPhone 17', description: 'Max Blue. Incluye: Funda, Glass, Cargador y Auriculares de regalo!', stock: true, image: getImg('iphone_17_pro_max_512gb_blue.png') },
  { id: 'ip17pm-512-sl', name: 'iPhone 17 Pro Max 512GB (Silver)', price: 1670, category: 'iPhone 17', description: 'Max Silver. Incluye: Funda, Glass, Cargador y Auriculares de regalo!', stock: true, image: getImg('iphone_17_pro_max_512gb_silver.png') },
  { id: 'ip17pm-1tb', name: 'iPhone 17 Pro Max 1TB', price: 1910, category: 'iPhone', description: 'Orange, Blue, Silver. Incluye: Funda, Glass, Cargador y Auriculares de regalo!', stock: true, colors: ['Orange', 'Blue', 'Silver'], image: getImg('iphone_17_pro_max_1tb_silver.png') },
  { id: 'ip17pm-2tb', name: 'iPhone 17 Pro Max 2TB', price: 2300, category: 'iPhone', description: 'Orange, Blue, Silver. Incluye: Funda, Glass, Cargador y Auriculares de regalo!', stock: true, colors: ['Orange', 'Blue', 'Silver'], image: getImg('iphone_17_pro_max_2tb_silver.png') },
  ...
  // GAMING
  // ==========================================
  { id: 'ps5-dig-noj', name: 'PS5 Digital (Sin Juegos)', price: 540, category: 'Gaming', description: 'Sony PlayStation 5 Slim', stock: true, image: getImg('ps5_digital__sin_juegos_.png') },
  { id: 'ps5-dig-j', name: 'PS5 Digital (Con Juegos)', price: 560, category: 'Gaming', description: 'Returnal + Ratchet Clank', stock: true, image: getImg('ps5_digital__con_juegos_.png') },
  { id: 'ps5-fis-j1', name: 'PS5 Física (Con Juegos 1)', price: 620, category: 'Gaming', description: 'Returnal + Ratchet Clank', stock: true, image: getImg('ps5_f_sica__con_juegos_.png') },
  { id: 'ps5-fis-j2', name: 'PS5 Física (Con Juegos 2)', price: 660, category: 'Gaming', description: 'Gran Turismo 7 + Astrobot', stock: true, image: getImg('ps5_f_sica__con_juegos_.png') },
  { id: 'ps5-pro', name: 'PS5 Pro Digital 2TB', price: 895, category: 'Gaming', description: 'La más potente', stock: true, image: getImg('ps5_pro_digital_2tb__sin_juego_.png') },
  { id: 'sw2', name: 'Nintendo Switch 2', price: 670, category: 'Gaming', description: 'Nueva Generación', stock: true, image: getImg('nintendo_switch_2.png') },
  { id: 'sw2-mk', name: 'Nintendo Switch 2 + Mario Kart', price: 690, category: 'Gaming', description: 'Bundle Mario Kart', stock: true, image: getImg('nintendo_switch_2___juego_mario_kart.png') },
  { id: 'xbox-x', name: 'Xbox Series X 1TB', price: 850, category: 'Gaming', description: 'Microsoft 4K', stock: true, image: getImg('xbox_x_1tb.png') },
  { id: 'xbox-s-1tb', name: 'Xbox Series S 1TB', price: 660, category: 'Gaming', description: 'Carbon Black', stock: true, image: getImg('xbox_s_1tb.png') },
  { id: 'xbox-s-512', name: 'Xbox Series S 512GB', price: 560, category: 'Gaming', description: 'Robot White', stock: true, image: fallbackImg },
  { id: 'mq3s-128', name: 'Meta Quest 3S 128GB', price: 495, category: 'Gaming', description: 'VR Accesible', stock: true, image: getImg('ps5_vr2___horizon.png') },
  { id: 'mq3s-256', name: 'Meta Quest 3S 256GB', price: 560, category: 'Gaming', description: 'Mayor capacidad', stock: true, image: getImg('ps5_vr2___horizon.png') },
  { id: 'mq3-512', name: 'Meta Quest 3 512GB', price: 750, category: 'Gaming', description: 'Mixed Reality Pro', stock: true, image: getImg('ps5_vr2___horizon.png') },
  ...
  { id: 'dual-sense', name: 'Joystick Dual Sense', price: 100, category: 'Accesorios', description: 'Original PS5', stock: true, image: getImg('joystick_dual_sense.png') },
  { id: 'g29', name: 'Volante Logitech G29', price: 360, category: 'Accesorios', description: 'PC/PS', stock: true, image: getImg('volante_logitech_g29.png') },
  { id: 'vr2', name: 'PS5 VR2 + Horizon', price: 630, category: 'Accesorios', description: 'Realidad Virtual PS5', stock: true, image: getImg('ps5_vr2___horizon.png') },
  ...
  { id: 'jbl-go4', name: 'JBL GO 4', price: 50, category: 'Accesorios', description: 'Portable', stock: true, image: getJblImg('jbl_go4.png') },
  { id: 'jbl-flip7', name: 'JBL FLIP 7', price: 140, category: 'Accesorios', description: 'Waterproof', stock: true, image: getJblImg('jbl_flip_7.png') },
  { id: 'jbl-ch6', name: 'JBL CHARGE 6', price: 200, category: 'Accesorios', description: 'Powerbank', stock: true, image: getJblImg('jbl_charge_6.png') },
  { id: 'jbl-bb4', name: 'JBL BOOMBOX 4', price: 600, category: 'Accesorios', description: 'Massive Sound', stock: true, image: fallbackImg },
  { id: 'jbl-pb710', name: 'JBL PARTYBOX 710', price: 800, category: 'Accesorios', description: 'Fiesta Total', stock: true, image: getJblImg('jbl_partybox_710.png') },
  { id: 'jbl-tour', name: 'JBL Tour Pro 2', price: 190, category: 'Accesorios', description: 'Smart Case', stock: true, image: getJblImg('jbl_tour_pro_2.png') },
  { id: 'jbl-520', name: 'JBL TUNE 520BT', price: 65, category: 'Accesorios', description: 'Purple, Black', stock: true, image: getJblImg('jbl_tune_520bt.png') },
];