...
export const PRODUCTS: Product[] = [
  ...
  // IPHONES NUEVOS
  // ==========================================
  { id: 'ip14-128', name: 'iPhone 14 128GB', price: 590, category: 'iPhone', description: 'Apple iPhone 14', stock: true, image: getImg('iphone_14_128gb.png') },
  { id: 'ip15-128', name: 'iPhone 15 128GB', price: 670, category: 'iPhone', description: 'Dynamic Island', stock: true, image: getImg('iphone_15_128gb.png') },
  { id: 'ip15-256', name: 'iPhone 15 256GB', price: 800, category: 'iPhone', description: 'Dynamic Island', stock: true, image: getImg('iphone_15_128gb.png') },
  { id: 'ip15p-128', name: 'iPhone 15 Plus 128GB', price: 780, category: 'iPhone', description: 'Pantalla Grande', stock: true, image: getImg('iphone_15_plus_512gb.png') },
  { id: 'ip15p-512', name: 'iPhone 15 Plus 512GB', price: 880, category: 'iPhone', description: 'Máxima capacidad', stock: true, image: getImg('iphone_15_plus_512gb.png') },

  // iPhone 16
  { id: 'ip16e-128', name: 'iPhone 16E 128GB', price: 640, category: 'iPhone', description: 'Nueva Edición', stock: true, image: getImg('iphone_16e_128gb.png') },
  { id: 'ip16e-256', name: 'iPhone 16E 256GB', price: 750, category: 'iPhone', description: 'Nueva Edición', stock: true, image: getImg('iphone_16e_256gb.png') },
  { id: 'ip16-128', name: 'iPhone 16 128GB', price: 790, category: 'iPhone', description: 'A18 Chip', stock: true, image: getImg('iphone_16_128gb.png') },
  { id: 'ip16-256', name: 'iPhone 16 256GB', price: 880, category: 'iPhone', description: 'A18 Chip', stock: true, image: getImg('iphone_16_256gb.png') },
  { id: 'ip16pl-128', name: 'iPhone 16 Plus 128GB', price: 880, category: 'iPhone', description: 'Gran Pantalla', stock: true, image: getImg('iphone_16_plus_128gb.png') },
  { id: 'ip16pl-256', name: 'iPhone 16 Plus 256GB', price: 1000, category: 'iPhone', description: 'Gran Pantalla', stock: true, image: getImg('iphone_16_plus_256gb.png') },
  { id: 'ip16pro-128', name: 'iPhone 16 Pro 128GB', price: 1080, category: 'iPhone', description: 'Titanium', stock: true, image: getImg('iphone_16_pro_128gb.png') },
  { id: 'ip16promax-256', name: 'iPhone 16 Pro Max 256GB', price: 1330, category: 'iPhone', description: 'Solo Desert Titanium', stock: true, image: getImg('iphone_16_pro_max_256gb_desert.png') },

  // iPhone 17
  { id: 'ip17-256', name: 'iPhone 17 256GB', price: 990, category: 'iPhone', description: 'White, Blue, Lavender, Sage', stock: true, colors: ['White', 'Blue', 'Lavender', 'Sage'], image: getImg('iphone_17_256gb_blue.png') },
  { id: 'ip17air-256', name: 'iPhone 17 Air 256GB', price: 980, category: 'iPhone', description: 'Ultra Thin. Black, White, Blue, Gold', stock: true, colors: ['Black', 'White', 'Blue', 'Gold'], image: getImg('iphone_17_air_256gb_black.png') },
  { id: 'ip17pro-256-og', name: 'iPhone 17 Pro 256GB (Orange)', price: 1330, category: 'iPhone', description: 'Titanium Orange', stock: true, image: getImg('iphone_17_pro_256gb_orange.png') },
  { id: 'ip17pro-256-bl', name: 'iPhone 17 Pro 256GB (Blue)', price: 1340, category: 'iPhone', description: 'Titanium Blue', stock: true, image: getImg('iphone_17_pro_256gb_blue.png') },
  { id: 'ip17pro-256-sl', name: 'iPhone 17 Pro 256GB (Silver)', price: 1350, category: 'iPhone', description: 'Titanium Silver', stock: true, image: getImg('iphone_17_pro_256gb_silver.png') },
  { id: 'ip17pro-512-og', name: 'iPhone 17 Pro 512GB (Orange)', price: 1530, category: 'iPhone', description: 'Titanium Orange', stock: true, image: getImg('iphone_17_pro_512gb_orange.png') },
  { id: 'ip17pro-512-bl', name: 'iPhone 17 Pro 512GB (Blue)', price: 1540, category: 'iPhone', description: 'Titanium Blue', stock: true, image: getImg('iphone_17_pro_512gb_blue.png') },
  { id: 'ip17pro-512-sl', name: 'iPhone 17 Pro 512GB (Silver)', price: 1540, category: 'iPhone 17', description: 'Titanium Silver', stock: true, image: getImg('iphone_17_pro_512gb_silver.png') },
  { id: 'ip17pro-1tb', name: 'iPhone 17 Pro 1TB', price: 1760, category: 'iPhone', description: 'Orange, Blue, Silver', stock: true, colors: ['Orange', 'Blue', 'Silver'], image: getImg('iphone_17_pro_1tb_silver.png') },
  { id: 'ip17pm-256-og', name: 'iPhone 17 Pro Max 256GB (Orange)', price: 1420, category: 'iPhone', description: 'Max Orange', stock: true, image: getImg('iphone_17_pro_max_256gb_orange.png') },
  { id: 'ip17pm-256-bl', name: 'iPhone 17 Pro Max 256GB (Blue)', price: 1430, category: 'iPhone', description: 'Max Blue', stock: true, image: getImg('iphone_17_pro_max_256gb_blue.png') },
  { id: 'ip17pm-256-sl', name: 'iPhone 17 Pro Max 256GB (Silver)', price: 1430, category: 'iPhone', description: 'Max Silver', stock: true, image: getImg('iphone_17_pro_max_256gb_silver.png') },
  { id: 'ip17pm-512-og', name: 'iPhone 17 Pro Max 512GB (Orange)', price: 1640, category: 'iPhone', description: 'Max Orange', stock: true, image: getImg('iphone_17_pro_max_512gb_orange.png') },
  { id: 'ip17pm-512-bl', name: 'iPhone 17 Pro Max 512GB (Blue)', price: 1670, category: 'iPhone 17', description: 'Max Blue', stock: true, image: getImg('iphone_17_pro_max_512gb_blue.png') },
  { id: 'ip17pm-512-sl', name: 'iPhone 17 Pro Max 512GB (Silver)', price: 1670, category: 'iPhone 17', description: 'Max Silver', stock: true, image: getImg('iphone_17_pro_max_512gb_silver.png') },
  { id: 'ip17pm-1tb', name: 'iPhone 17 Pro Max 1TB', price: 1910, category: 'iPhone', description: 'Orange, Blue, Silver', stock: true, colors: ['Orange', 'Blue', 'Silver'], image: getImg('iphone_17_pro_max_1tb_silver.png') },
  { id: 'ip17pm-2tb', name: 'iPhone 17 Pro Max 2TB', price: 2300, category: 'iPhone', description: 'Orange, Blue, Silver', stock: true, colors: ['Orange', 'Blue', 'Silver'], image: getImg('iphone_17_pro_max_2tb_silver.png') },
